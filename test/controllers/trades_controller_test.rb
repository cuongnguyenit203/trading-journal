...
class TradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trade" do
    assert_difference("Trade.count") do
      post trades_url, params: { trade: { entry_price: @trade.entry_price, note: @trade.note, profit: @trade.profit, symbol: @trade.symbol } }
    end
  ...
  test "should update trade" do
    patch trade_url(@trade), params: { trade: { entry_price: @trade.entry_price, note: @trade.note, profit: @trade.profit, symbol: @trade.symbol } }
